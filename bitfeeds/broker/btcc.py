...
class BtccBroker(RESTfulApiSocket):
    """
...
class ExchGwBtcc(ExchangeGateway):
    ...
    def __init__(self, db_storages):
        ...
        """
        ExchangeGateway.__init__(self, RESTfulApiSocket(), db_storages)
...
class ExchGwBtccSpotRestfulApi(RESTfulApiSocket):
    """
...
class ExchGwBtccFutureRestfulApi(RESTfulApiSocket):
    """
    Exchange gateway Spot Instrument RESTful API
    """
    def __init__(self):
...
class ExchGwBtccSpot(ExchGwBtcc):
    ...
    def __init__(self, db_storages):
        ...
        :param db_storage: Database storage
        """
        ExchangeGateway.__init__(self, ExchGwBtccSpotRestfulApi(), db_storages)
...
class ExchGwBtccFuture(ExchGwBtcc):
    ...
    def __init__(self, db_storages):
        ...
        :param db_storage: Database storage
        """
        ExchangeGateway.__init__(self, ExchGwBtccFutureRestfulApi(), db_storages)
...
if __name__ == '__main__':
    ...
    exch = ExchGwBtccSpot([db_storage])
    instmt.set_l2_depth(L2Depth(5))
    instmt.set_prev_l2_depth(L2Depth(5))
